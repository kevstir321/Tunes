"""
Django settings for TeamTunes project.
...
SECRET_KEY = 'cbg&y&0tarm7p06^j@63qd^!y+h+gqa69@cwwat(k+zvq(ki47'
...
WSGI_APPLICATION = 'TeamTunes.wsgi.application'
