...
class User(models.Model):
	...
	profile_picture = models.ImageField(upload_to = 'images/users/', blank = True, null = True)#upload_to=)
...
class Event(models.Model):
	...
	image = models.ImageField(upload_to = 'images/events/', blank = True, null = True)#upload_to=)
